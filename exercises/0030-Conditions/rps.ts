...
function mouseClicked() {
    ...
    if (computer === "") {
        ...
        // Only continue when the click actually hit one of the icons.
        // Without this check, a click on the empty canvas would also
        // trigger the computer's choice and end the game.
        if (selected !== "") {
